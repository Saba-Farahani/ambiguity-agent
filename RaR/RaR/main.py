...
parser.add_argument('--task', type=str,
    choices=[
        ...
        'last_letter_concatenation4', 'sports', 'date', 'csqa', 'stereo','diagnosis_partial_full',
        'diagnosis_partial_partial1', 'diagnosis_partial_partial2',
        'diagnosis_partial_partial3'
    ],
